    ...
    <div class="detail-container">
      <el-row>
        ...
        <el-col :span="24">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item prop="filePath" label="封面路径：" :label-width="labelWidth">
                <el-input
                  v-model="postForm.filePath"
                  placeholder="封面路径"
                  disabled
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item prop="contents" label="目录：" :label-width="labelWidth">
                <div v-if="contentsTree && contentsTree.length > 0" class="contentsTree-wrapper">
                  <el-tree :data="contentsTree" @node-click="handleNodeClick" />
                </div>
                <span v-else>无</span>
              </el-form-item>
            </el-col>
